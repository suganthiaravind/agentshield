...
def _render_how_it_works(parts: list[str]) -> None:
    ...
    parts.append(
        ...
        '--mode {verify|explore|both} [--classifier llm] [--synthesize]'
        '</code>'
        '<span class="how-stage-cli-note">'
        ...
        '<li class="how-step">'
        '<span class="how-step-label">Pick the right attack for each issue</span>'
        '<div class="how-step-body">'
        'For every issue, AgentShield reaches into its built-in library '
        'of attack scripts and picks the one designed to test that kind '
        ...
        '<li class="how-step">'
        '<span class="how-step-label">Tailor the attack to your agent '
        '<em>(the smart-customisation step)</em></span>'
        '<div class="how-step-body">'
        'Different agents have different tools, roles, and capabilities. '
        'AgentShield customises every attack so it actually fits your '
        'agent &mdash; using the names of <em>your</em> tools, <em>your</em> '
        'role labels, <em>your</em> typical user actions. Three sources '
        'fill in the customisation values, in order:'
        ...
        'reads the same instruction files described in Stage 2 '
        '(<code>SKILL.md</code>, <code>AGENT.md</code>, etc.), learns '
        'what tools and roles the agent has, and fills in the '
        'customisation values automatically. '
        '<span class="how-step-files-inline">'
        ...
        '<li class="how-step">'
        '<span class="how-step-label">Fill in the blanks</span>'
        '<div class="how-step-body">'
        ...
        '<li class="how-step">'
        '<span class="how-step-label">Send the attack</span>'
        '<div class="how-step-body">'
        '<ul class="how-sub-list">'
        '<li><strong>For attacks that could damage state</strong> '
        ...
        '<li class="how-step">'
        '<span class="how-step-label">Decide what happened</span>'
        '<div class="how-step-body">'
        'AgentShield looks at the agent\'s response and reaches one of '
        'four conclusions:'
        '<ul class="how-sub-list">'
        '<li><strong>Attack landed</strong> &mdash; the agent did what '
        'the attacker asked. The vulnerability is exploitable.</li>'
        '<li><strong>Attack blocked</strong> &mdash; a defensive layer '
        '(WAF, auth gate, rate limit) caught it before the agent ever '
        'saw it.</li>'
        '<li><strong>Inconclusive</strong> &mdash; the response doesn\'t '
        'clearly indicate either outcome; recommend a human review.</li>'
        '<li><strong>Error</strong> &mdash; couldn\'t reach the agent '
        '(network failure, timeout, etc.).</li>'
        '</ul>'
        'Two methods are used, and the AI\'s verdict wins when both run:'
        '<ol class="how-step-substeps">'
        ...
        'no security defences, so every attack here lands. Against a '
        'real agent with WAFs, auth gates, and rate limits in place, '
        'you\'ll see </em><strong>blocked</strong><em>, </em>'
        '<strong>inconclusive</strong><em>, and </em><strong>error'
        '</strong><em> verdicts naturally &mdash; AgentShield reports '
        'all four outcomes accurately.</em></div>'
        '</div>'
        '</li>'
