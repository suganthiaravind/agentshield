...
def _render_solution_diagram(parts: list[str]) -> None:
    ...
    parts.append(
        ...
        # FIX.MD highlight — pill background to make it stand out
        '<rect x="918" y="528" width="270" height="52" rx="8" '
        'fill="#fdf4ff" stroke="#d8b4fe" stroke-width="1.2"/>'
        '<text x="1053" y="548" text-anchor="middle" '
        'font-family="system-ui, sans-serif" font-size="13" '
        'font-weight="800" fill="#7c3aed">'
        'FIX.MD per finding</text>'
        '<text x="1053" y="564" text-anchor="middle" '
        'font-family="system-ui, sans-serif" font-size="9" '
        'fill="#7c3aed">'
        'paste into Claude / Copilot for step-by-step fix</text>'
        '<text x="1053" y="600" text-anchor="middle" '
        'font-family="system-ui, sans-serif" font-size="9" '
        'fill="#64748b" font-style="italic">'
