...
def _render_how_it_works(parts: list[str]) -> None:
    ...
    parts.append(
        ...
        '13 attack classes &times; 8 attempts = <strong>104 total payloads per scan</strong>. '
        'The campaign for each class stops the moment a payload succeeds — '
        'remaining mutations are not fired.'
        '</p>'
        '<div class="how-step-files">'
        '<span class="how-step-files-label">Data structure:</span> '
        ...
        'The pipeline trace you see in the Play animation is the walk of that '
        'winning (or last-attempted) payload through each targeted pipeline step — '
        'showing exactly where the attack advanced and where a defence stopped it.</p>'
        '</div>'
